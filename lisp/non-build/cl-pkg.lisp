...
(defpackage :common-lisp
   ...
   *STANDARD-OUTPUT* *TERMINAL-IO* *TRACE-OUTPUT* + ++ +++ - / // ///
   ...
   AUGMENT-ENVIRONMENT BASE-CHAR BASE-STRING BIGNUM BIT BIT-AND
   ...
   DECLARATION-INFORMATION DECLARE DECODE-FLOAT DECODE-UNIVERSAL-TIME
   DEFCLASS DEFCONSTANT DEFGENERIC DEFINE-COMPILER-MACRO
   DEFINE-CONDITION DEFINE-DECLARATION DEFINE-METHOD-COMBINATION
   ...
   EIGHTH ELT ENCLOSE ENCODE-UNIVERSAL-TIME END-OF-FILE ENDP
   ...
   FUNCTION FUNCTION-INFORMATION FUNCTION-KEYWORDS
   FUNCTION-LAMBDA-EXPRESSION FUNCTIONP GCD GENERIC-FLET
   GENERIC-FUNCTION GENERIC-LABELS GENSYM GENTEMP GET GET-DECODED-TIME
   ...
   PARSE-INTEGER PARSE-MACRO PARSE-NAMESTRING PATHNAME PATHNAME-DEVICE
   ...
   SPECIAL-OPERATOR-P SPEED SQRT STABLE-SORT STANDARD-CHAR
   ...
   STRING= STRING> STRING>= STRINGP STRUCTURE-OBJECT STYLE-WARNING SUBLIS
   ...
   VARIABLE-INFORMATION VECTOR VECTOR-POP VECTOR-PUSH
   VECTOR-PUSH-EXTEND VECTORP WARN WARNING WHEN WILD-PATHNAME-P
   WITH-ACCESSORS WITH-ADDED-METHODS WITH-COMPILATION-UNIT
   WITH-CONDITION-RESTARTS WITH-HASH-TABLE-ITERATOR
   WITH-INPUT-FROM-STRING WITH-OPEN-FILE WITH-OPEN-STREAM
   WITH-OUTPUT-TO-STRING WITH-PACKAGE-ITERATOR WITH-SIMPLE-RESTART
   WITH-SLOTS WITH-STANDARD-IO-SYNTAX WRITE WRITE-BYTE WRITE-CHAR
   WRITE-LINE WRITE-STRING WRITE-TO-STRING Y-OR-N-P YES-OR-NO-P
   ZEROP))
)